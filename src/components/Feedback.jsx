        ...
        <div className="cards">
          <div className="card-body">
            ...
            <p className="cardtext">
              We are thrilled with the exceptional work <br /> Qrest has done on
              our customer app, rider <br /> app, and admin panel. They have
              truly <br /> transformed our business operations and <br />
              enhanced the overall customer experience. <br /> The Qrest team's
              expertise and attention to <br /> detail have been invaluable
              throughout the <br /> development process. <br />
